...
export function RelatorioReceitas() {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      const mockData: Lancamento[] = [
        ...
        {
          id: "4",
          descricao: "Mensalidade Cliente X",
          valor: 500.00,
          dataVencimento: "2026-04-05",
          dataPagamento: null,
          status: "ATRASADO",
          categoria: { nome: "Recorrente" },
        },
      ];
  ...
  const totalReceitas = filteredData.reduce((sum, l) => sum + l.valor, 0);
    ...
    <div className="p-8 bg-gray-50 min-h-screen">
      <div className="mb-6">
        ...
        <div className="flex items-center justify-between">
          <h1 className="text-3xl font-bold text-gray-900">Relatório Analítico - Receitas</h1>
          <ExportButton data={exportData} filename="relatorio-receitas" type="receitas" />
        </div>
      </div>
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
        <p className="text-sm text-blue-700">Total de Receitas ({filteredData.length} lançamentos)</p>
